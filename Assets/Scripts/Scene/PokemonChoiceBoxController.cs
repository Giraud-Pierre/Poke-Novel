...
{
    /*Placer sur la boite de choix du premier pokemon et génère les boutons 
    ...
    private void GenerateButton(List<int> starters) //Genère les boutons
    {
        ...
        for (int i = 1; i < starters.Count; i++) //Pour tous les starters aorès le premier
        {
            ...
            currentButton = nextButton; //Met-àjour le current bouton pour pouvoir crée le suivant comme il faut.
        }
    }
}
